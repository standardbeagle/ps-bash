...
public class PipeTransformTests
{
    ...
    {
        Assert.Equal("cmd | Invoke-BashGrep \"pattern\"", Apply("cmd | grep pattern"));
    }

    [Fact]
    public void PipeGrepInvert_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashGrep -NotMatch \"pattern\"", Apply("cmd | grep -v pattern"));
    }

    [Fact]
    public void PipeGrepCaseInsensitive_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashGrep -CaseInsensitive \"pattern\"", Apply("cmd | grep -i pattern"));
    }

    [Fact]
    public void PipeGrepRecurse_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashGrep -Recurse \"pattern\" dir", Apply("cmd | grep -r pattern dir"));
    }

    [Fact]
    public void PipeHead_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashHead -n 10", Apply("cmd | head -n 10"));
    }

    [Fact]
    public void PipeTail_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashTail -n 5", Apply("cmd | tail -n 5"));
    }

    [Fact]
    public void PipeWcL_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashWc -l", Apply("cmd | wc -l"));
    }

    [Fact]
    public void PipeSort_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashSort", Apply("cmd | sort"));
    }

    [Fact]
    public void PipeSortReverse_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashSort -r", Apply("cmd | sort -r"));
    }

    [Fact]
    public void PipeUniq_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashUniq", Apply("cmd | uniq"));
    }

    [Fact]
    public void PipeSed_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashSed 's/x/y/'", Apply("cmd | sed 's/x/y/'"));
    }

    [Fact]
    public void PipeAwk_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashAwk '{print $1}'", Apply("cmd | awk '{print $1}'"));
    }
    ...
    {
        Assert.Equal("cmd | Invoke-BashXargs", Apply("cmd | xargs"));
    }

    [Fact]
    public void PipeTr_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashTr 'a' 'b'", Apply("cmd | tr 'a' 'b'"));
    }

    [Fact]
    public void PipeTee_Transforms()
    {
        Assert.Equal("cmd | Invoke-BashTee output.txt", Apply("cmd | tee output.txt"));
    }
